...
import styles from './placeSearchComponent.module.css'
...
export function PlaceSearchComponent(props: props) {
    ...
    const onExpandLabelClick = (element: any, index: number) => {
    ...
    //지도로 이동 버튼 클릭
    const onSelectButtonClick = (element: any) => {
